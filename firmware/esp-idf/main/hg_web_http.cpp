...
esp_err_t WebHttp::index_get(httpd_req_t* request) { return send_asset(request, "text/html; charset=utf-8", index_html_start, index_html_end); }
esp_err_t WebHttp::css_get(httpd_req_t* request) { return send_asset(request, "text/css; charset=utf-8", app_css_start, app_css_end); }
esp_err_t WebHttp::js_get(httpd_req_t* request) { return send_asset(request, "application/javascript; charset=utf-8", app_js_start, app_js_end); }
