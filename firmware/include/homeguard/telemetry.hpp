...
struct TelemetryFrame {
 ...
 std::array<ZoneState,5> zones{}; std::array<PressureState,2> pressures{}; HealthState health{HealthState::Unknown}; uint32_t failed_components{};
