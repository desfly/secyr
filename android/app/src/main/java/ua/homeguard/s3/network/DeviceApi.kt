...
interface DeviceApi {
    ...
    suspend fun inputPolarity(): InputPolarityConfig
    suspend fun configureInputPolarity(config: InputPolarityConfig, actor: String, credential: String): InputPolarityConfig
}
